  ...
  const displayTreatments = useApiData
    ? [
        ...apiData!.treatments.map((t) => ({
          ...
          description: t.speciality ? f"Related to {t.speciality}" : "",
          duration: "",
        ...
        ...apiData!.procedures.map((p) => ({
          ...
          description: p.speciality ? f"Related to {p.speciality}" : "",
          duration: "",
...
content = re.sub(count_regex, derived_data_str, content)
